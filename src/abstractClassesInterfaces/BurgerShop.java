...
public class BurgerShop extends Franchise {
    ...
    //It has to follow all the "rules" set
    //in the "Franchise" abstract class
    ...
    ///Override the methods that have to be written, per the
    //"Franchise" abstract class
    @Override
    ...
    public static void main(String[] args) {
        ...
        BurgerShop mcDonaldsSanAntonio = new BurgerShop("Casey", theseMenuItems, theseCategories, 200, 800, 2300, true);
