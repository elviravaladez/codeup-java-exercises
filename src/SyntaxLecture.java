...
//                 String y; //String is a Reference Data Type. It's considered an object in Java
...
//                 System.out.println(x); //x = 4;
        ...
        //If you don't assign int x to anything and try to access it via
        //System.out.println(x) you will get an ERROR

        //BUT if you don't assign x to anything and DON'T try to access via
        //a System.out.println(x), your code will run AND won't show an error
...
//        int x = 5;
//                 x++;
//        System.out.println(x); //Would equate to 6
...
//        System.out.println(++x); //Would equate to 6
//        System.out.println(x++); //Would equate to 6
//        System.out.println(x); //Would equate to 7
